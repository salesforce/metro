...
def markdown_to_xhtml(title, 
                      ...
                      working_draft = None):
    """markdown_to_xhtml(md_content, table_of_contents = None, working_draft = None) -> xhtml_content
...
#                confML += '<ac:parameter ac:name="theme">Midnight</ac:parameter>'
    ...
    def add_working_draft(xhtml, draft_link):
        badge = '<ac:structured-macro ac:name="panel">\n<ac:parameter ac:name="title">This page is a work in progress</ac:parameter>\n'
        badge += '<ac:rich-text-body>Make a suggestion in <a href="%s"><b>the working draft</b></a>, or log a bug with <a href="https://gus.lightning.force.com/lightning/r/ADM_Work__c/a07B0000006DQ3GIAW/view"><b>this template</b></a> in GUS.</ac:rich-text-body>.\n'%draft_link
    ...
    if working_draft:
        xhtml = add_working_draft(xhtml, working_draft)
    return xhtml
