...
function convert_to_md() 
{
  ...
  text += '<p>You can publish the contents of this zip file to Confluence with <a href="https://git.soma.salesforce.com/internal-doc-tools/metro">metro</a>:</p>\n';
  text += '<code>./import_pages -z ~/Downloads/' + zip.getName() + ' -u ' + username + '</code>\n';
...
function help()
{
  var page = "https://git.soma.salesforce.com/internal-doc-tools/metro#converting-a-google-doc";
